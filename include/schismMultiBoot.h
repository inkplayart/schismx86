/*
  When in doubt about what any of the weird shifts mean, look here:
...
#ifndef SCHISMMULTIBOOT
#define SCHISMMULTIBOOT
...
void _MB_getMMapInHeader(multiBootHeader* mbh);
